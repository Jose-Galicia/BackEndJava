public class GwenStacy extends Spiderman implements AtaqueSpiderGwen{
    public GwenStacy(String Nombre, String Universo, String Sexo, int Ataques, String Descripcion) {
